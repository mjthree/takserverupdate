...
1. Navigate to the `tak-update-builder` folder
2. Double-click `build-update.bat` or run it from command prompt
3. Or specify a folder: `build-update.bat "C:\path\to\apk\folder"`
...
1. Navigate to the `tak-update-builder` folder
2. **Important:** Before first use, make the script executable:
   ```bash
   chmod +x build-update.sh
   ```
